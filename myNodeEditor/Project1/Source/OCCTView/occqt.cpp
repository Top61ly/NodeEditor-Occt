...
{
	QString myIconPath = "F:/VSProject/myNodeEditor/Project1/Source";
	mExitAction = new QAction(tr("Exit"), this);
	mExitAction->setShortcut(tr("Ctrl+Q"));
	mExitAction->setIcon(QIcon(myIconPath+"/Resource Files/close.png"));
	mExitAction->setStatusTip(tr("Exit the application"));
	connect(mExitAction, SIGNAL(triggered()), this, SLOT(close()));

	mViewZoomAction = new QAction(tr("Zoom"), this);
	mViewZoomAction->setIcon(QIcon(myIconPath+"/Resources/Zoom.png"));
	...
	mViewPanAction->setIcon(QIcon(myIconPath+"/Resources/Pan.png"));
	...
	mViewRotateAction->setIcon(QIcon(myIconPath+"/Resources/Rotate.png"));
	...
	mViewResetAction->setIcon(QIcon(myIconPath+"/Resources/Home.png"));
	...
	mViewFitallAction->setIcon(QIcon(myIconPath+"/Resources/FitAll.png"));
	...
	mMakeBoxAction->setIcon(QIcon(myIconPath + "/Resources/box.png"));
	...
	mMakeConeAction->setIcon(QIcon(myIconPath + "/Resources/cone.png"));
	...
	mMakeSphereAction->setIcon(QIcon(myIconPath + "/Resources/sphere.png"));
	...
	mMakeCylinderAction->setIcon(QIcon(myIconPath + "/Resources/cylinder.png"));
	...
	mMakeTorusAction->setIcon(QIcon(myIconPath + "/Resources/torus.png"));
	connect(mMakeTorusAction, SIGNAL(triggered()), this, SLOT(makeTorus()));

	mFilletAction = new QAction(tr("Fillet"), this);
	mFilletAction->setIcon(QIcon(myIconPath + "/Resources/fillet.png"));
	...
	mChamferAction->setIcon(QIcon(myIconPath + "/Resources/chamfer.png"));
	...
	mExtrudeAction->setIcon(QIcon(myIconPath + "/Resources/extrude.png"));
	...
	mRevolveAction->setIcon(QIcon(myIconPath + "/Resources/revolve.png"));
	...
	mLoftAction->setIcon(QIcon(myIconPath + "/Resources/loft.png"));
	...
	mCutAction->setIcon(QIcon(myIconPath + "/Resources/cut.png"));
	...
	mFuseAction->setIcon(QIcon(myIconPath + "/Resources/fuse.png"));
	...
	mCommonAction->setIcon(QIcon(myIconPath + "/Resources/common.png"));
	...
	myHelixAction->setIcon(QIcon(myIconPath + "/Resources/helix.png"));
	...
	mAboutAction->setIcon(QIcon(myIconPath + "/Resources/lamp.png"));
...
void occQt::preProcess() {
	myOccView->getContext()->EraseAll();
}

void occQt::postProcess() {
	myOccView->fitAll();
}

//--------------------------------
void occQt::addNewShapeFromNodeEditor() {
	if (AllShapes::size()) {
		preProcess();
		for (int i = 0; i < AllShapes::size(); i++) {
			if (AllShapes::getShape(i).IsNull()) {
				continue;
			}
				Handle(AIS_Shape) anNewShape = new AIS_Shape(AllShapes::getShape(i));

				anNewShape->SetColor(Quantity_NOC_AZURE);

				myOccView->getContext()->Display(anNewShape);
